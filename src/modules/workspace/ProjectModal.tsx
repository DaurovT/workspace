...
import type { ProjectMemberRole } from '../../store';
...
const ProjectModal: React.FC = () => {
  const isProjectModalOpen = useStore(state => state.isProjectModalOpen);
      const projectModalMode = useStore(state => state.projectModalMode);
      const closeProjectModal = useStore(state => state.closeProjectModal);
  ...
  const closeModal = closeProjectModal;
